...
describe('ImageEditor', () => {
  ...
  it('correctly styles the radiused circle button on click', () => {
    const radiusedCircleToolContainer = screen.getByTestId(
      'drawing-tool-button-radiusedcircle'
    );
    const radiusedCircleToolStyledDiv =
      radiusedCircleToolContainer.querySelector('div');
  ...
  it('correctly styles the rectangle button on click', () => {
    const rectangleToolContainer = screen.getByTestId(
      'drawing-tool-button-rectangle'
    );
    const radiusedCircleToolStyledDiv =
      rectangleToolContainer.querySelector('div');
